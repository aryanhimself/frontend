            ...
            <Dropdown as={Nav.Item}>
              ...
              <Dropdown.Menu className="user-dropdown dropdown-menu-right mt-2">
                <Dropdown.Item className="fw-bold">
                  <FontAwesomeIcon icon={faGift} className="me-2" /> Reward Points: {userInfo.reward_points}
                </Dropdown.Item>
                <Dropdown.Item className="fw-bold">
                ...
                <Dropdown.Item className="fw-bold" onClick={(event) => {
                  ...
                  authAxios.post('/auth/logout').then(res => {
                    return res.data;
                  }).catch(err => {
                    return err?.res?.data || {};
                  });
                  localStorage.clear();
                  toast("Logged Out Successfully. Redirecting to Login Page", successToast);
                  navigate('/auth/login');
                }}>
                  <FontAwesomeIcon
                    icon={faSignOutAlt}
