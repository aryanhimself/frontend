  ...
  return (
    <Card border="light" className="shadow-sm">
      <Card.Header className="border-bottom border-light">
        <h5 className="mb-0">Tax Collection Categories</h5>
      </Card.Header>
      <Card.Body>
        <Progress
          title="Income Tax - Married"
          color="purple"
          icon={faPeopleLine}
          percentage={10}
        />
...
export const SalesValueWidget = (props) => {
  ...
  return (
    <Card className="bg-secondary-alt shadow-sm">
      ...
      <Card.Body className="p-2">{/* <SalesValueChart /> */}</Card.Body>
    </Card>
  );
};
...
export const SalesValueWidgetPhone = (props) => {
  ...
  return (
    <Card className="bg-secondary-alt shadow-sm">
      ...
      <Card.Body className="p-2">{/* <SalesValueChartphone /> */}</Card.Body>
    </Card>
  );
};
